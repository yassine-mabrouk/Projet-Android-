...
import com.enset.healthcareapp.adapter.PatRequestAdapter;
import com.enset.healthcareapp.model.Request;
...
public class PatientRequestPage extends AppCompatActivity {
    ...
    private PatRequestAdapter adapterRequest;
    ...
    private void setUpRecyclerView() {
        ...
        adapterRequest = new PatRequestAdapter(options);
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                adapterRequest.deleteItem(viewHolder.getAdapterPosition());
            }
